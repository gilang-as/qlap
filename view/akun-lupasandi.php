                ...
                <div class="row">
					<div class="col-lg-6 col-md-6 d-flex">
						<div class="text-info max-w400 align-self-center">
							...
							<h2 class="m-b10">Ubah Sandi Akun Anda</h2>
							<p class="m-b30">Silahkan buka email anda untuk mendapatkan verifikasi ubah sandi dengan mendapatkan kode token dan masukkan pada form disini.</p>
						...
						<div class="login-2 submit-resume p-a30 seth">
							<div class="tab-content nav">
								<form id="login" method="POST" class="tab-pane active col-12 p-a0 ">
									<p class="font-weight-600">Buka email anda untuk mendapatkan token</p>
									<div class="form-group">
										<label>Token</label>
										<div class="input-group">
											<input name="token" required class="form-control" type="txt">
										</div>
									</div>
									<div class="form-group">
										<label>Sandi</label>
										<div class="input-group">
											<input name="sandi" required class="form-control" type="password">
										</div>
									</div>
									<div class="text-center">
										<button class="site-button float-left">Verifikasi</button>
                                    </div>
								</form>
							</div>
						</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-center">
						<span class="float-left">© Copyright by <i class="fa fa-heart m-lr5 text-red heart"></i>
