						...
						<div class="col-xl-9 col-lg-8 m-b30">
							<div class="job-bx job-profile">
								<div class="job-bx-title clearfix">
									<h5 class="font-weight-700 pull-left text-uppercase">Mengubah Informasi Kecamatan</h5>
									...
									<div class="row m-b30">
										<div class="col-lg-6 col-md-6">
											<div class="form-group">
												...
												<input type="text" id="nama" name="nama" class="form-control" placeholder="Nama Kecamatan" value="<?php echo $result["nama"];?>">
											</div>
										</div>
										<div class="col-lg-6 col-md-6">
											<div class="form-group">
										...
										<div class="col-lg-12 col-md-12">
											<div class="form-group">
												...
												<textarea id="informasi" name="informasi" class="form-control" placeholder="Informasi Kecamatan"><?php echo $result["informasi"];?></textarea>
											</div>
										</div>
									</div>
									<div class="job-bx-title clearfix">
									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6">
											<div class="form-group">
												...
												<input id="coords" name="coords" type="text" value="<?php echo $a["coords"];?>" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6">
											<div class="form-group">
												<label>Area:</label>
												<input id="area" name="area" type="text" value="<?php echo $a["area"];?>" class="form-control">
											</div>
										</div>
										<div class="col-lg-4 col-md-4">
											<div class="form-group">
												<label>Corner:</label>
												<input type="text" id="corner" name="corner" type="text" value="<?php echo $a["corner"];?>" class="form-control">
											</div>
										</div>
										<div class="col-lg-4 col-md-4">
											<div class="form-group">
												<label>Center Latitude:</label>
												<input id="lat" name="lat" type="text" value="<?php echo $a["lat"];?>" class="form-control">
											</div>
										</div>
										<div class="col-lg-4 col-md-4">
											<div class="form-group">
												<label>Center Longitude:</label>
												<input id="lng" name="lng" type="text" value="<?php echo $a["lng"];?>" class="form-control">
											</div>
										</div>
									</div>
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCowOsHWcNwlICLg2hLmwm7nxPIkG2m-8Y&libraries=drawing"></script>	       
    <script>
			var map = null;
			var drawingManager;
			var selectedShape;
