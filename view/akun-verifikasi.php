                ...
                <div class="row">
					<div class="col-lg-6 col-md-6 d-flex">
						<div class="text-info max-w400 align-self-center">
							...
							<h2 class="m-b10">Verifikasi Akun Anda</h2>
							<p class="m-b30">Silahkan buka email anda untuk mendapatkan verifikasi dengan mendapatkan kode token dan masukkan pada form disini.</p>
