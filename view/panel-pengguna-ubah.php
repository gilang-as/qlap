                                        ...
                                        <div class="row m-b30">
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="nama" name="nama" class="form-control" placeholder="Nama Pengguna" value="<?php echo $result["nama"];?>" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" id="surel" name="surel" class="form-control" placeholder="surel@domain.id" value="<?php echo $result["surel"];?>" required>
                                                </div>
                                            </div>
											<div class="col-lg-6 col-md-6">
                                                <div class="form-group">
													...
													<select id="level" name="jekel" required>
														<option <?php if($result["jekel"]==1){echo "selected";}?> value="1">Laki-laki</option>
														<option <?php if($result["jekel"]==2){echo "selected";}?> value="2">Perempuan</option>
													</select>
												</div>
                                            </div>
											<div class="col-lg-4 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" id="lahir" name="lahir" class="form-control" placeholder="Tanggal Lahir"  value="<?php echo $result["lahir"];?>" required>
                                                </div>
                                            </div>
											<div class="col-lg-4 col-md-4">
                                                <div class="form-group">
													...
													<select id="level" name="level" required>
														<option <?php if($result["jekel"]==3){echo "selected";}?>  value="3">Masyarakat</option>
														<option <?php if($result["jekel"]==2){echo "selected";}?>  value="2">Staf</option>
														<option <?php if($result["jekel"]==1){echo "selected";}?>  value="1">Administrator</option>
													</select>
                                                </div>
                                            </div>
											<div class="col-lg-4 col-md-4">
											...
											<div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" id="sandi" name="sandi" class="form-control" placeholder="Sandi" required>
                                                </div>
                                            </div>
                                        </div>
